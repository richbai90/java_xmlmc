...
abstract public class Service {
    ...
    /**
     * Generates a new xmlmc.Request with the session specified in the constructor and a method provided when called.
     *
     * @param method the method of the service this API wraps see xmlmc documentation for details
     * @return {@code new xmlmc.Request}
     *
     * @see Request
     */
     ...
     * @return {@code new xmlmc.Response}
     *
